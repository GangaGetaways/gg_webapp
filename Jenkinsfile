            ...
            steps {
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'cloud-ssh-id', keyFileVariable: 'SSH_KEY')]) {
                        ...
                        """
                        if (GIT_LOCAL_BRANCH == FEATURE_BRANCH) {
                        ...
                        } else if (GIT_LOCAL_BRANCH == DEV_BRANCH) {
                        ...
                        } else if (GIT_LOCAL_BRANCH == 'release') {
                            ...
                            echo "Skipping deployment for branch: $GIT_LOCAL_BRANCH"
                        }
                    }
                }
            }
